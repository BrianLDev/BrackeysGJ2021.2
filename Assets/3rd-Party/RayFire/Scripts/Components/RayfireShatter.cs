...
namespace RayFire
{
    ...
    public class RayfireShatter : MonoBehaviour
    {
        ...
        [Tooltip ("Low poly, convex, physics friendly fragments, generate custom point cloud mirrored at the edges over defined axes.")]
        [HideInInspector] public RFMirrored mirrored = new RFMirrored();
        [Space (2)]
