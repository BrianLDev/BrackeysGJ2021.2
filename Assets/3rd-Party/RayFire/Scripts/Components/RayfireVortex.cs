...
namespace RayFire
{
    ...
    [HelpURL ("http://rayfirestudios.com/unity-online-help/components/unity-vortex-component/")]
    public class RayfireVortex : MonoBehaviour
    {
        ...
        [HideInInspector] public List<Rigidbody> myRigidbodies = new List<Rigidbody>(); // TODO custom list
        ...
        [Range (0.1f, 50f)] public float topRadius = 15f;
        [Space (2)]
        [Range (0.0f, 50f)] public float bottomRadius = 3f;

        [Header ("Eye")]
        
        [Range (0.05f, 0.9f)] public float eye = 0.1f;

        [Header ("Strength")]
        
        public bool forceByMass = true;
        [Space (2)]
        [Range (1,    10)] public float stiffness = 1f;
        [Space (2)]
        [Range (-40f, 40)] public float swirlStrength = 10f;

        [Header ("Torque")]
        
        public bool enableTorque = true;
        [Space (2)]
        [Range (-1f, 1f)] public float torqueStrength  = 0.5f;
        [Space (2)]
        [Range (0f,  1f)] public float torqueVariation = 0.5f;

        [Header ("Height bias")]
        
        public bool enableHeightBias = true;
        [Space (2)]
        [Range (0f, 1f)] public float biasSpeed  = 0.025f;
        [Space (2)]
        [Range (0f, 1f)] public float biasSpread = 1;
        ...
        [Header ("Preview")]
        [Range (2, 10)] public int circles = 3;
        [HideInInspector] public bool showGizmo = true;
        [HideInInspector] public bool topHandle = false;
