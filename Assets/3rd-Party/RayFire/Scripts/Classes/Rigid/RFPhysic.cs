...
namespace RayFire
{
    ...
    public class RFPhysic
    {
        ...
        // Set density. After collider defined.
        public static void SetDensity(RFPhysic physics, RFShard shard, float density)
        {
            // Default mass from inspector
        ...
        public static void SetPhysics(List<RFShard> shards, RFPhysic physic)
        {
            ...
            for (int i = 0; i < shards.Count; i++)
            {
                ...
                if (shards[i].rigid == null)
                {
                    ...
                    // Set density. After collider defined
                    SetDensity (physic, shards[i], density);
        ...
        {
            return System.Object.ReferenceEquals(rb, null);
        }
