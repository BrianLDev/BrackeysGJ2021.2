        ...
        public static bool DemolishReference (RayfireRigid scr)
        {
            if (scr.demolitionType == DemolitionType.ReferenceDemolition)
            {
                ...
                if (instScr != null)
                {
                    ...
                    // Get ref rigid
                    else if (instScr.objectType == ObjectType.Mesh ||
                             instScr.objectType == ObjectType.SkinnedMesh)
                    {
                    ...
                    // Get ref rigid
                    else if (instScr.objectType == ObjectType.NestedCluster ||
                             instScr.objectType == ObjectType.ConnectedCluster)
                    {
                        instScr.Default();
