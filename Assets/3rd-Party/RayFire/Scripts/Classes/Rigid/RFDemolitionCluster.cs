...
namespace RayFire
{
    ...
    public class RFDemolitionCluster
    {
        ...
        // Editor Clusterize
        public static bool ClusterizeEditor(RayfireRigid scr)
        {
            // Not cluster
        ...
        {
            // Prepare
            if (scr.fragments == null) scr.fragments = new List<RayfireRigid>();
            else scr.fragments.Clear();
        ...
        public static void CreateClusterRuntime (RayfireRigid scr, RFCluster cluster)
        {
            ...
            if (scr != cluster.rigid)
            {
                ...
                // Set parent RigidRoot for new Connected cluster in case source Rigid has parent RigidRoot
                if (scr.rigidRoot != null)
        ...
        // Detach shards from child clusters at edges TODO not used
